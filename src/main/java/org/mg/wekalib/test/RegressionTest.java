...
public class RegressionTest
{
	...
	{
		String datasets[] = new String[] { "auto93", "autoHorse", "autoMpg", "autoPrice", "baskball", "bodyfat",
				"cholesterol", "cleveland", "cloud", "cpu", "detroit", "echoMonths", "elusage", "fishcatch", "gascons",
				"housing", "hungarian", "longley", "lowbwt", "mbagrade", "meta", "pbc", "pharynx", "pollution",
				"pwLinear", "schlvote", "sensory", "servo", "sleep", "strike", "veteran", "vineyard" };
		//too-big: "quake"
